    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[oklch(10%_0_0)]">
      ...
      <div className="container relative z-10 pt-28 pb-20 flex justify-center">
        <div className="max-w-[720px] w-full mx-auto px-4 md:px-8">
          ...
          <p className="text-[18px] text-[oklch(78%_0.005_85)] leading-[1.75] mb-12 max-w-[540px]"
          ...
          <div className="flex flex-wrap gap-4"
            ...
            <Link href="/chi-siamo"
              className="inline-flex items-center gap-2 px-8 py-3.5 text-[16px] font-semibold border border-[oklch(60%_0.005_85)] text-[oklch(88%_0.005_85)] transition-all duration-300 hover:border-[#A67C52] hover:text-[#A67C52] hover:gap-3"
              style={{ fontFamily: 'var(--font-ui)' }}>
              La Nostra Storia
            </Link>
          </div>
