  ...
  return (
    ...
    >
      <div className={cn("container max-w-3xl mx-auto", innerClassName)}>
        ...
        {children ? (
          <div className="page-header-intro space-y-4 max-w-2xl text-[1.0625rem] leading-[1.75] [font-family:var(--font-body)]">
            {children}
          </div>
        ) : null}
        <div className="brand-divider mt-8" role="presentation" aria-hidden />
      </div>
    </section>
  );
}
